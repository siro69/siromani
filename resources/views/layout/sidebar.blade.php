...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="menu">
        <ul class="list">
            ...
            @endrole
           @role('master')
            <li class="{{ Request::segment(1) === 'manage_users' ? 'active open' : null }}">
                <a href="#App" class="menu-toggle"><i class="zmdi zmdi-apps"></i> <span>Manage Users</span></a>
                <ul class="ml-menu">

                    <li class="{{ Request::segment(2) === 'users' ? 'active' : null }}"><a href="{{route('admin.users.index')}}">User</a></li>
            ...
            <li class="{{ Request::segment(1) === 'manage_blogs' ? 'active open open_top' : null }}">
                <a href="#Map" class="menu-toggle"><i class="zmdi zmdi-map"></i><span>Manage Blogs</span></a>
                <ul class="ml-menu">
                    <li class="{{ Request::segment(2) === 'manage_blogs' ? 'active' : null }}"><a href="{{route('admin.manage_blog.index')}}">Blog Categories</a></li>
                    <li class="{{ Request::segment(2) === 'manage_blogs' ? 'active' : null }}"><a href="{{route('admin.manage_blog.create')}}">Create New  Categories</a></li>

                </ul>
            </li>

            <li class="{{ Request::segment(1) === 'jobs' ? 'active open open_top' : null }}">
                <a href="#Map" class="menu-toggle"><i class="zmdi zmdi-map"></i><span>Manage  Jobs</span></a>
                <ul class="ml-menu">
                    <li class="{{ Request::segment(2) === 'jobs' ? 'active' : null }}"><a href="{{route('admin.jobs.index')}}">Jobs</a></li>
                    <li class="{{ Request::segment(2) === 'jobs' ? 'active' : null }}"><a href="{{route('admin.jobs.create')}}">Create New  Jobs</a></li>

                </ul>
            </li>
            <li class="{{ Request::segment(1) === 'manage_employes' ? 'active open open_top' : null }}">
                <a href="#Map" class="menu-toggle"><i class="zmdi zmdi-map"></i><span>Manage Employes</span></a>
                <ul class="ml-menu">
{{--                    <li class="{{ Request::segment(2) === 'manage_employes' ? 'active' : null }}"><a href="{{route('admin.manage_employes.today')}}">Totals Blog</a></li>--}}

                    <li class="{{ Request::segment(2) === 'manage_employes' ? 'active' : null }}"><a href="{{route('admin.manage_employes.index')}}">Totals Employers</a></li>
                    <li class="{{ Request::segment(2) === 'manage_employes' ? 'active' : null }}"><a href="{{route('admin.manage_employes.create')}}">Today's  Employer</a></li>

                </ul>
            </li>
            <li class="{{ Request::segment(1) === 'jobseekers' ? 'active open open_top' : null }}">
                <a href="#Map" class="menu-toggle"><i class="zmdi zmdi-map"></i><span>Manage Jobseekeres</span></a>
                <ul class="ml-menu">
                    <li class="{{ Request::segment(2) === 'jobseekers' ? 'active' : null }}"><a href="{{route('admin.jobseekers.index')}}">Totals JobSeekers</a></li>
                    <li class="{{ Request::segment(2) === 'jobseekers' ? 'active' : null }}"><a href="{{route('admin.jobseekers.create')}}">Today's JobSeeker</a></li>

                </ul>
            </li>

            {{-- <li class="{{ Request::segment(1) === 'map' ? 'active open open_top' : null }}">
                <a href="#Map" class="menu-toggle"><i class="zmdi zmdi-map"></i><span>Generals</span></a>
                <ul class="ml-menu">
                    <li class="{{ Request::segment(2) === 'generals' ? 'active' : null }}"><a href="{{route('advertisement')}}">Generals</a></li>
                    <li class="{{ Request::segment(2) === 'generals' ? 'active' : null }}"><a href="{{route('advertisement')}}">Locations</a></li>
                    <li class="{{ Request::segment(2) === 'generals' ? 'active' : null }}"><a href="{{route('advertisement')}}">Categories</a></li>
                    <li class="{{ Request::segment(2) === 'generals' ? 'active' : null }}"><a href="{{route('advertisement')}}">Manage Clients</a></li>
                    <li class="{{ Request::segment(2) === 'generals' ? 'active' : null }}"><a href="{{route('advertisement')}}">Manage Education List</a></li>


                </ul>
            </li> --}}
            <li class="{{ Request::segment(1) === 'jobseekers' ? 'active open open_top' : null }}">
                <a href="{{ route('frontend.home') }}" class="menu-toggle"><i class="zmdi zmdi-map"></i><span>Leave Dashboard</span></a>
