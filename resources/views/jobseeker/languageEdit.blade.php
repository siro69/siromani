        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-md-9 p-0 border bg-white">
                ...
                <h6 class="px-3 mb-0 py-2 d-flex">
                    <span> <i data-feather="mic" class="p-1"></i> Language </span>
                </h6>
                <hr class="m-0">

                <form action="" class="personal-detail form" >
                    <div style="padding:20px 80px" class="inner-form">
                    <div class="row px0 py-3 border">
                        <div class="col-md-11 d-flex mb-3">
                            <label for="" class="col-4 m-auto">  Language Name* </label>
                        ...
                        <div class="col-md-11 d-flex mb-3">
                            <label for="" class="col-4 m-auto"> Proficiency Reading </label>
                            <div class="input-group border  d-flex p-0">
                            <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-11 d-flex mb-3">
                            <label for="" class="col-4 m-auto">Proficiency Writing  </label>
                            <div class="input-group border  d-flex p-0">
                            <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-11 d-flex mb-3">
                            <label for="" class="col-4 m-auto">Proficiency Speaking  </label>
                            <div class="input-group border  d-flex p-0">
                            <input type="text" class="form-control">
                            </div>
                        </div>
