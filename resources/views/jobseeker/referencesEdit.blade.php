        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-md-9 p-0 border bg-white">
                ...
                <h6 class="px-3 mb-0 py-2 d-flex">
                    <span> <i data-feather="clipboard" class="p-1"></i> Reference </span>
                </h6>
                <hr class="m-0">

                <form action="" class="personal-detail form" >
                    <div style="padding:20px 80px" class="inner-form">
                    <div class="row px-0 py-3 border">
                        <div class="col-md-12 d-flex">
                            <label for="" class="col-3 m-auto"> Reference Name* </label>
                        ...
                        <div class="col-md-12 d-flex my-3">
                            <label for="" class="col-3 m-auto pl-0">Reference Email* </label>
                            <div class="input-group border  d-flex p-0">
                            <input type="email" class="form-control" >
                            </div>
                        </div>
                        <div class="col-md-12 d-flex mb-3">
                            <label for="" class="col-3 m-auto"> Name Of Company* </label>
                            <div class="input-group border  d-flex p-0">
                            <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12 d-flex mb-3">
                            <label for="" class="col-3 m-auto pl-0"> Name Of Department* </label>
                            <div class="input-group border  d-flex p-0">
                                <input type="text" class="form-control">
                            </div>
                        ...
                        <div class="col-md-12 d-flex mb-3">
                            <label for="" class="col-3 m-auto pl-0">Address </label>
                            <div class="input-group border  d-flex p-0">
                                <input type="text" class="form-control">
                            </div>
                        ...
                        <div class="col-md-12 d-flex mb-3">
                            <label for="" class="col-3 m-auto pl-0">Mobile </label>
                            <div class="input-group border  d-flex p-0">
                        ...
                        <div class="col-md-12 d-flex mb-3">
                            <label for="" class="col-3 m-auto pl-0">Relationship </label>
                            <div class="input-group border  d-flex p-0">
                                <input type="text" class="form-control">
                            </div>
