...
<section id="premium-job">
    ...
    <div class="container p-0">
        ...
        <div class="row mt-3 mb-5 p-0 m-0">
                        ...
                        <div class="w-15 text-center left-side">
                            ...
                            <div class="jobname pt-3 border p-3 my-3">
                                ...
                                <div class="d-flex flex-wrap mt-3">
                                    <div class="d-flex btns-group px-2 flex-fill">
                                    ...
                                    <a href="" class="flex-fill btn px-2"><button class="btn bg-light border w-100 mt-1"><i
