        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-md-9 p-0 border bg-white">
                ...
                <h6 class="px-3 mb-0 py-2 d-flex">
                    <span> <i data-feather="award" class="p-1"></i> Skill </span>
                </h6>
                <hr class="m-0">
                ...
                <form action="" class="personal-detail form" >
                    ...
                    <div class="row p-3 border">
                        <div class="col-md-12 d-flex">
                            <label for="" class="col-3 m-auto"> Skill Title* </label>
                        ...
                        <div class="col-md-12 d-flex my-3">
                            <label for="" class="col-3 m-auto pl-0"> Set Your Skill* </label>
                            <div class="input-group py-2 px-4 border  d-flex p-0">
                       
                                <input type="range" class="custom-range" min="0" max="5" id="customRange2 " id="formControlRange">
