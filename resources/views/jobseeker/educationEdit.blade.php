        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-md-9 p-0 border bg-white">
                ...
                <h6 class="px-3 mb-0 py-2 d-flex">
                    <span> <i data-feather="clipboard" class="p-1"></i> Education </span>
                </h6>
                <hr class="m-0">
                ...
                <form action="" class="personal-detail form" >
                    ...
                    <div class="row p-3 border">
                        <div class="col-md-12 d-flex">
                            <label for="" class="col-3 m-auto"> Degree Level* </label>
                            <div class="input-group border  d-flex p-0">

                            <select class="form-control" name="degree_type" id="education" placeholder="Current education"> <option class="hidden"> Current Education </option> <option value="below SLC/SEE"> below SLC/SEE </option> <option value="SLC/SEE"> SLC/SEE </option> <option value="Intermediate" selected=""> Intermediate </option> <option vlaue="Bachelors"> Bachelors </option> <option value="Masters"> Masters </option> </select>
                            </div>

                        </div>
                        <div class="col-md-12 d-flex my-3">
                            <label for="" class="col-3 m-auto pl-0"> Course(BSC,BED)* </label>
                            <div class="input-group border  d-flex p-0">
                            <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12 d-flex mb-3">
                            <label for="" class="col-3 m-auto"> College/School* </label>
                            <div class="input-group border  d-flex p-0">
                            <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12 d-flex">
                            <label for="" class="col-3 m-auto pl-0"> Board* </label>
                            <div class="input-group border  d-flex p-0">
                                <input type="text" class="form-control">
                            </div>
                        ...
                        <div class="col-md-12 mt-3 per" id="per">
                            <label for="" class="col-3 m-auto pl-0"> Percentage/GPA </label>
