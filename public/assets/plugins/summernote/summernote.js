...
(function (factory) {
  ...
  var defaults = {
    ...
    options: {
      ...
      // lineHeight
      lineHeights: ['1.0', '2', '1.4', '1.5', '1.6', '1.8', '2.0', '3.0'],
  ...
  var Renderer = function () {
     ...
     * @return {function(className, title=, body=, footer.blade.php.blade.php=):string} return.dialog {@link #tplDialog function to make dialog}
     */
