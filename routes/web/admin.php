...
Route::group(['namespace' => 'Admin', 'prefix' => 'admindashboard', 'as' => 'admin.'], function () {

    Route::resource('/manage_blog', 'BlogCatController');
    Route::resource('/jobseekers', 'JobSeekerController');
    Route::resource('/manage_employes', 'EmployerController');
    Route::resource('/manage_employes', 'EmployerController');
...
//Static routes for just view of the file
